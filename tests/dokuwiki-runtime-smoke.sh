...
grep -q 'vector-feature-limited-width-content-enabled' "$SMOKE_WORKDIR/vector-2022-page.html"
grep -q 'vector-header-container' "$SMOKE_WORKDIR/vector-2022-page.html"
grep -q 'mw-page-container-inner' "$SMOKE_WORKDIR/vector-2022-page.html"
grep -q '<main id="content" class="mw-body">' "$SMOKE_WORKDIR/vector-2022-page.html"
grep -q 'id="bodyContent" class="dokuwiki vector-body"' "$SMOKE_WORKDIR/vector-2022-page.html"
grep -q 'id="p-search" role="search" class="vector-search-box-vue' "$SMOKE_WORKDIR/vector-2022-page.html"
grep -q 'class="mw-logo"' "$SMOKE_WORKDIR/vector-2022-page.html"
grep -q 'vector-page-titlebar' "$SMOKE_WORKDIR/vector-2022-page.html"
grep -q 'vector-page-toolbar' "$SMOKE_WORKDIR/vector-2022-page.html"
grep -q 'id="vector-page-tabs"' "$SMOKE_WORKDIR/vector-2022-page.html"
grep -q 'id="vector-page-actions"' "$SMOKE_WORKDIR/vector-2022-page.html"
grep -q 'vector-main-menu-button' "$SMOKE_WORKDIR/vector-2022-page.html"
grep -q 'vector-main-menu-landmark' "$SMOKE_WORKDIR/vector-2022-page.html"
grep -q 'id="vector-main-menu-dropdown"' "$SMOKE_WORKDIR/vector-2022-page.html"
...
grep -q 'vector-toc-landmark' "$SMOKE_WORKDIR/vector-2022-page.html"
grep -q 'id="vector-page-tools"' "$SMOKE_WORKDIR/vector-2022-page.html"
grep -q 'vector-page-tools-landmark' "$SMOKE_WORKDIR/vector-2022-page.html"
grep -q 'vector-column-end' "$SMOKE_WORKDIR/vector-2022-page.html"
grep -q 'id="p-appearance"' "$SMOKE_WORKDIR/vector-2022-page.html"
grep -q 'id="vector-appearance"' "$SMOKE_WORKDIR/vector-2022-page.html"
...
grep -q 'vector-page-toolbar' "$SMOKE_WORKDIR/vector-2022.css"
grep -q 'vector-main-menu-open' "$SMOKE_WORKDIR/vector-2022.css"
grep -q 'vector-column-end' "$SMOKE_WORKDIR/vector-2022.css"
